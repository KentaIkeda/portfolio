      ...
      <div className="space-y-12">
        <section>
          ...
          <p className="mt-4 mb-2">
            I write articles regarding daily questions. The articles I write include my own understanding. You may gain
            new insights!
          </p>
          <Link prefetch href="/blog" className="btn btn-wide btn-dash btn-circle btn-secondary">
            Read article
          </Link>
        </section>
        <section>
          ...
          <Link prefetch href="/products" className="btn btn-wide btn-dash btn-circle btn-secondary">
            View product
          </Link>
        </section>
      </div>
